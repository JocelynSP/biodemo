'''
Module      :  FastaStats
Description : Central stats class for biodemo.
Copyright   : (c) Jocelyn, 29 Nov 2018 
License     : MIT 
Maintainer  : penington.j@wehi.edu.au 
Portability : POSIX
...
class FastaStats(object):
    ...
    def from_file(self, fasta_file, minlen_threshold=DEFAULT_MIN_LEN, maxlen_threshold=None):
        ...
        Arguments:
           ...
           maxlen__threshold: the maximum length sequence to consider in
              computing the statistics. Sequences in the input FASTA file
              which have a length greater than this value are ignored and not
              considered in the resulting statistics.
        Result:
           A FastaStats object
        '''
